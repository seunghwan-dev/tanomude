...
モックと併せて、3つの関連ページがあります。

- **[Tanomude — 全体像](https://seunghwan-dev.github.io/tanomude/about/)** — 何を・なぜ（技能伝承）・どう動くか・測定された裏づけ・アーキテクチャを1ページで通覧します。
- **[実装状況とロードマップ](https://seunghwan-dev.github.io/tanomude/status/)** — 項目ごとの正直な実装台帳。実装済 73・部分実装 11・意図的延期 27・全 111 行で、延期項目も明示します。
- **[運用設計ノート](https://seunghwan-dev.github.io/tanomude/operations/)** — どう運用する設計か：SLO・アラート・オンコール・ロールバック・育成汚染の検知。設計意図のみで、現時点で稼働しているものはありません。
